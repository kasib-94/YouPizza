    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IngredientsProduct", x => new { x.IngredientsId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_IngredientsProduct_Ingriedients_IngredientsId",
                        column: x => x.IngredientsId,
                        principalTable: "Ingriedients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IngredientsProduct_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IngredientsProduct_ProductId",
